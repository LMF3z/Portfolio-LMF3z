  ...
  return (
    <div className='lg:max-h-screen mt-5 md:mt-0 space-y-2 lg:col-span-3 lg:pb-5 px-5 lg:px-10 lg:overflow-y-auto scroll-smooth'>
      <section id='about' className='lg:pt-16 text-wrap text-lg'>
        ...
        <p>
          I love playing with new technologies, analyzing and understanding from
          the requirements of what you want to create to the moment of giving
          life to the most exciting and impressive systems. My beginnings were
          with the frontend using React Js, curiosity led me to learn backend,
          using mainly Node Js frameworks. Having the opportunity to work for
          companies in Venezuela, Peru, Guatemala and Spain.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          where, (in the last 6 months my main role has been as a backend
          developer with Nest) we have created web and mobile applications,
          helping to accelerate and improve both administrative and operational
          processes, ranging from a purchase order to customer delivery.
        </p>
        <br />
