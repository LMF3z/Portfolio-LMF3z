...
const GridSkills = () => {
    return (
        <section className="w-full min-h-screen p-10 text-white flex flex-col justify-center items-center space-y-10 text-justify">
            <img src={images.skills} alt="profile-icon" className="w-20 h-20" />
            <h1 className="text-violet text-6xl" >Skills</h1>
